...
for (i in 1:6) {
  ...
  write.csv(
    df_i,
    file = paste0(
      "/Users/mrn29/Library/CloudStorage/OneDrive-YaleUniversity/Yale/TB/DR-TB-Modelling/Cost-effectiveness/Decision Trees/Extended Tree - XDR-TB/Decision Tree ML/PM Boostrap/moldova_data_opt_treat_classification_allthresholds_wtp",
      i, ".csv"
    ),
    row.names = FALSE
  )
